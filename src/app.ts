...
import { addDeveloper, addDeveloperInfo, deleteDeveloper, getAllProjectsAndTechnologies, getDeveloper, updateDeveloper, updateDeveloperInfo  } from "./logic/developers";
import { addProjects, addTechnologiesProjects, deleteProject, getAllProjects, getProjectById, updateProjects } from "./logic/projects";
...
import { ensureProjectExistsMiddleware, ensureProjectsExistsIdMiddleware, ensureUpdateInfoProjectsExists } from "./middlewares/projects.middlewares";
...
app.get("/developers", getAllProjectsAndTechnologies)
...
app.post("/projects/:id/technologies", addTechnologiesProjects)
